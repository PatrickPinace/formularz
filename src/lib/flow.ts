  ...
  // Krok 4: Dane osobowe wspólne
  {
    ...
    fields: [
      ...
      },
      {
        id: 'address_main',
        type: 'textarea',
        labelKey: 'field.address_main.label',
        required: true,
        placeholder: 'field.address_main.placeholder',
      },
    ],
    next: [
    ...
    fields: [
      {
        ...
        required: true,
        options: [
          { value: 'polozna_a', labelKey: 'field.midwife_choice.option.polozna_a' },
          { value: 'polozna_b', labelKey: 'field.midwife_choice.option.polozna_b' },
          { value: 'polozna_c', labelKey: 'field.midwife_choice.option.polozna_c' },
          { value: 'nie_wiem', labelKey: 'field.midwife_choice.option.nie_wiem' },
        ],
      },
      {
        id: 'due_date',
      ...
      {
        id: 'postpartum_address',
        type: 'textarea',
        labelKey: 'field.postpartum_address.label',
        required: true,
        visibleIf: [{ field: 'postpartum_same_address', equals: 'nie' }],
        placeholder: 'field.postpartum_address.placeholder',
      },
      {
