...
function getMockContent(): ContentMap {
  return {
    ...
    'field.address_main.label': 'Adres zamieszkania',
    'field.address_main.placeholder': 'Ulica, numer domu/mieszkania, kod pocztowy, miasto',
    ...
    'field.postpartum_address.label': 'Adres pobytu po porodzie',
    'field.postpartum_address.placeholder': 'Ulica, numer, kod pocztowy, miasto',
